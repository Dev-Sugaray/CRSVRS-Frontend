	...
	<div>
		...
		<cui-body>
			...
			<div class="row">
				...
				<div class="col-6">
					<cui-input :store="vehicleTypeStore" stateKey="searchStr" placeholder="Search vehicleTypes"></cui-input>
				</div>
				<div class="col-1">
					...
					<div class="table-body">
						...
						>
							...
							<div class="table-row-col col col text-right">
								<cui-button data-bs-toggle="modal" :data-bs-target="'#edit_vehicleType'.concat(vehicleType.vehicle_type_id)">
									<i class="fa fa-pen"></i>
									Edit
								</cui-button>&nbsp;
								<cui-button type='danger' data-bs-toggle="modal" :data-bs-target="'#delete_vehicleType'.concat(vehicleType.vehicle_type_id)">
				...
				<div class="modal-body">
					<div class="row">
						<div class="container">
							...
							<cui-input :store="vehicleTypeStore" stateKey="vehicleTypeToAddSurname" type="text" placeholder="Vehicle type"></cui-input>
						</div>
					</div>
				</div>
			...
			<div class="modal-content" style="overflow-y: auto; max-height:85%;  margin-top: 50px; margin-bottom:50px;">
				...
				<div class="modal-footer">
					<div class="container mt-5 text-center">
						...
						<cui-button @click="updateVehicleType(vehicleType.vehicleType_id)" class="">Edit</cui-button>
					</div>
				</div>
			</div>
		</div>
...
<!-- delete vehicleType modal -->
	<div v-for="vehicleType in vehicleTypes" data-backdrop="static" :key="vehicleType.vehicleType_id" class="modal fade" :id="'delete_vehicleType'.concat(vehicleType.vehicle_type_id)">
		<div class="modal-dialog">
